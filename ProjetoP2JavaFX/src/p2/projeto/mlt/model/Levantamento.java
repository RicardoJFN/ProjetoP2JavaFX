...
public class Levantamento {
        ...
        /**
	 * Definicao de atributos da classe Levantamento
	 */
	...
	/**
	 * Construtor do Levantamento
	 * @param numLevantamento
	 * @param dataLevantamento
	 * @param primeiroPontoLat
	 * @param primeiroPontoLong
	 * @param segundoPontoLat
	 * @param segundoPontoLong
         * @param terceiroPontoLat
         * @param terceiroPontoLong
         * @param quartoPontoLat
         * @param quartoPontoLong
         * @param calculoArea
         * @param numeroEdificio
	 */
	public Levantamento(double numLevantamento, int dataLevantamento, double primeiroPontoLat, 
			    double primeiroPontoLong, double segundoPontoLat, double segundoPontoLong, 
                            double terceiroPontoLat,  double terceiroPontoLong, double quartoPontoLat, 
                            double quartoPontoLong, double calculoArea,Edificio numeroEdificio){
	 ...
	 */
        ...
        public Levantamento(int idLevantamento, double numLevantamento, int dataLevantamento, double primeiroPontoLat, 
                            double primeiroPontoLong, double segundoPontoLat, double segundoPontoLong, 
                            double terceiroPontoLat, double terceiroPontoLong,double quartoPontoLat, 
                            double quartoPontoLong, Edificio numeroEdificio){
	...
	public void setQuartoPontoLong(DoubleProperty quartoPontoLong) {
        ...
        /**
         * Metodo toString que retorna o numero de levantamento
         * @return 
         */
	...
	public String toString() {
        ...
        /**
         * Metodo de insercao de um novo NovoLevantamento na BD
         *  
         */
	public void inserirNovoLevantamento(){
        ...
        /**
         * Metodo que retorna uma ArrayList do tipo Levantamento
         * para devolver ID e Numero do Levantamento
         * Lev_id e uma Foreing Key na base de dados.
         * @return 
         */
        ...
        /**
         * Metodo que retorna uma ArrayList do tipo Levantamento
         * para devolver Numero e Data do Levantamento
         * @return 
         */
