...
public class Equipamento {
        ...
        /**
	 * Definicao de atributos da classe Equipamento
	 */
	...
	protected Estado estadoEquip;
        ...
        /**
         * Declaracao da variavel Estado do tipo enum " enumeracao "
         * esta variavel pode tomar os seguintes valores " EXCELENTE, RAZOAVEL, DEGRADADO "
         */
        
	public enum Estado {EXCELENTE, RAZOAVEL, DEGRADADO};
	
        /**
	 * Construtor do Equipamento com o ID como campo obrigatorio
	 * @param idEquip
	 * @param tipoEquip
	 * @param levantamento
	 * @param subTipoEquip
	...
	public void setEstadoEquip(Estado estadoEquip) {
        ...
        /**
         * Metodo de insercao de um novo Equipamento na BD
         *  
         */   
	...
	public void inserirEquipamento(Equipamento equipamento){
        ...
        /**
         * Metodo que retorna uma ArrayList do tipo Double e devolve o seguinte
         * dados Equip_valorestado.
         * @return 
         */
